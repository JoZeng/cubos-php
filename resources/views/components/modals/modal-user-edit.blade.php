        ...
        <div class="modal-content d-flex flex-column justify-content-center rounded-lg">
            <div class="d-flex flex-column">
                <div class="modal-header d-flex justify-content-center">
                    ...
                    <div class="pb-5"><button type="button" class="btn-close" data-bs-dismiss="modal"
                ...
                <form method="POST" action="{{ route('user.update', ['id' => $user->id]) }}"
                    ...
                    <div class="d-flex flex-column align-items-start w-100">
                        ...
                        <input class="w-100 p-2" type="password" name="password_confirmation" id="password_confirmation"
                            value="{{ old('password_confirmation') }}" placeholder="Digite sua Senha">
                    </div>

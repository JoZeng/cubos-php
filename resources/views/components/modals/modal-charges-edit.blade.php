...
<div class="modal fade" id="modalChargesEdit" tabindex="-1" aria-labelledby="modalChargesEditLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content d-flex flex-column justify-content-center rounded-lg">
            <div class="modal-header d-flex flex-column">
                <div class="d-flex justify-content-center">
                    <h5 class="modal-title text-center modal-text-padding" id="modalChargesEditLabel">
            ...
            @if ($client)
                <form id="chargesForm" method="POST" action=""
